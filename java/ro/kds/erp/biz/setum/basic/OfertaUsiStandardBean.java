...
public abstract class OfertaUsiStandardBean 
	...
	try {
	    ...
	    logger.log(BasicLevel.WARN, "Can not set the value of field: usa from the script", e);
        }
	try {
	    s.setVar("broasca", form.getBroasca(), String.class);
	} catch (ScriptErrorException e) {
	    logger.log(BasicLevel.WARN, "Can not set the value of field: broasca from the script", e);
        }
	try {
	    s.setVar("cilindru", form.getCilindru(), String.class);
	} catch (ScriptErrorException e) {
	    logger.log(BasicLevel.WARN, "Can not set the value of field: cilindru from the script", e);
        }
	try {
	    s.setVar("sild", form.getSild(), String.class);
	} catch (ScriptErrorException e) {
	    logger.log(BasicLevel.WARN, "Can not set the value of field: sild from the script", e);
        }
	try {
	    s.setVar("yalla", form.getYalla(), String.class);
	} catch (ScriptErrorException e) {
	    logger.log(BasicLevel.WARN, "Can not set the value of field: yalla from the script", e);
        }
	try {
	...
	try {
	    ...
	    logger.log(BasicLevel.WARN, "Can not get the value of field: usa from the script", e);
        }
	try {
	    ...
	    logger.log(BasicLevel.WARN, "Can not get the value of field: broasca from the script", e);
        }
	try {
	    ...
	    logger.log(BasicLevel.WARN, "Can not get the value of field: cilindru from the script", e);
        }
	try {
	    ...
	    logger.log(BasicLevel.WARN, "Can not get the value of field: sild from the script", e);
        }
	try {
	    ...
	    logger.log(BasicLevel.WARN, "Can not get the value of field: yalla from the script", e);
        }
	try {
