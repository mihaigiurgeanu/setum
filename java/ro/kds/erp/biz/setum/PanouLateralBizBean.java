...
import ro.kds.erp.biz.setum.basic.PanouLateralBean;
...
/**
 * Describe class PanouLateralBizBean here.
 *
 *
 * Created: Tue Jun 13 04:22:24 2006
 *
 * @author <a href="mailto:mihai@cris.kds.ro">Mihai Giurgeanu</a>
 * @version 1.0
 */
public class PanouLateralBizBean extends PanouLateralBean {
	...
	try {
	    ...
	    attributes.add(ah.create("lpl", form.getLpl()));
	    attributes.add(ah.create("hpl", form.getHpl()));
	...
	try {
	    ...
	    if((a = (AttributeLocal)attributes.get("lpl")) != null)
		form.setLpl(a.getDoubleValue());

	    if((a = (AttributeLocal)attributes.get("hpl")) != null)
		form.setHpl(a.getDoubleValue());
