 ...
 *
 *
 * Created: Wed Oct 05 20:02:01 2005
 *
...
public class UsaMetalica2KForm implements Serializable {
    ...
    /**
     * The type of 2K: equals or not equals.
     */
    private int kType;
     ...
     * Describe intFoil here.
     */
    private int intFoilSec;

    /**
     * Describe extFoil here.
     */
    private int extFoilSec;

    /**
     * Describe ieFoil here.
     */
    private int ieFoilSec;
    ...
    /**
     * Creates a new <code>UsaMetalica2KForm</code> instance.
     *
     */
    ...
    /**
     * Gets the value of lCurrent
     *
     * @return the value of lCurrent
     */
    public final double getLCurrent() {
	return this.lCurrent;
    }

    /**
     * Sets the value of lCurrent
     *
     * @param argLCurrent Value to assign to this.lCurrent
     */
    public final void setLCurrent(final double argLCurrent) {
	this.lCurrent = argLCurrent;
    }

    /**
     * Gets the value of kType
     *
     * @return the value of kType
     */
    ...
    /**
     * Sets the value of kType
     *
     * @param argKType Value to assign to this.kType
     */
    public final void setKType(final int argKType) {
	this.kType = argKType;
    }

    /**
     * Gets the value of intFoilSec
     *
     * @return the value of intFoilSec
     */
    public final int getIntFoilSec() {
	return this.intFoilSec;
    }

    /**
     * Sets the value of intFoilSec
     *
     * @param argIntFoilSec Value to assign to this.intFoilSec
     */
    public final void setIntFoilSec(final int argIntFoilSec) {
	this.intFoilSec = argIntFoilSec;
    }

    /**
     * Gets the value of extFoilSec
     *
     * @return the value of extFoilSec
     */
    public final int getExtFoilSec() {
	return this.extFoilSec;
    }

    /**
     * Sets the value of extFoilSec
     *
     * @param argExtFoilSec Value to assign to this.extFoilSec
     */
    public final void setExtFoilSec(final int argExtFoilSec) {
	this.extFoilSec = argExtFoilSec;
    }

    /**
     * Gets the value of ieFoilSec
     *
     * @return the value of ieFoilSec
     */
    public final int getIeFoilSec() {
	return this.ieFoilSec;
    }

    /**
     * Sets the value of ieFoilSec
     *
     * @param argIeFoilSec Value to assign to this.ieFoilSec
     */
    public final void setIeFoilSec(final int argIeFoilSec) {
	this.ieFoilSec = argIeFoilSec;
    }
