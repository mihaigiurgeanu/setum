...
public class UsaMetalica2KForm implements Serializable {
     ...
     * @return an RDF URI by concatenating the string <code>http://www.kds.ro/readybeans/rdf/forms/UsaMetalica2K#</code>
     * with the name of the field.
     */
     public static String uri(String fieldName) {
	return "http://www.kds.ro/readybeans/rdf/forms/UsaMetalica2K#" + fieldName;
     }
