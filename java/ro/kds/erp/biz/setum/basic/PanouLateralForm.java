 ...
 *
 */
public class PanouLateralForm implements Serializable {
     ...
     * @return an RDF URI by concatenating the string <code>http://www.kds.ro/readybeans/rdf/forms/PanouLateral#</code>
     * with the name of the field.
     */
     public static String uri(String fieldName) {
	return "http://www.kds.ro/readybeans/rdf/forms/PanouLateral#" + fieldName;
     }
    ...
    public PanouLateralForm() {
       ...
       this.lpl = new Double(0);
   


       this.hpl = new Double(0);
    ...
    public void setLpl(Double newLpl) {
        this.lpl = newLpl;
    }
    ...
    public void readLpl(Map attributes) {
	AttributeLocal a = (AttributeLocal)attributes.get("lpl");
	if(a != null) {
	    this.setLpl(a.getDoubleValue());
	}
    }

    public void setHpl(Double newHpl) {
        this.hpl = newHpl;
    }
    ...
    public void readHpl(Map attributes) {
	AttributeLocal a = (AttributeLocal)attributes.get("hpl");
	if(a != null) {
	    this.setHpl(a.getDoubleValue());
	}
    }
