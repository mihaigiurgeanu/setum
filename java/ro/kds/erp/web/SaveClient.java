...
/**
 * Describe class SaveClient here.
 *
 *
 * Created: Thu Sep 08 06:37:30 2005
 *
...
public class SaveClient extends HttpServlet {
	...
	try {
	    ...
	    try {
		stmt = conn.prepareStatement("UPDATE Client SET " +
					     "isCompany = ?, " +
					     "firstName = ?, " +
					     "lastName = ?, " +
					     "companyName = ?, " +
		...
		stmt.setInt(14, Integer.parseInt(httpServletRequest.getParameter("id")));
