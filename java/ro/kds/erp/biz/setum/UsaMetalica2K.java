...
public interface UsaMetalica2K extends EJBObject {
    ...
    public ResponseBean updateLCurrent(Double lCurrent) throws RemoteException;
    public ResponseBean updateKType(Integer kType) throws RemoteException;
    ...
    public ResponseBean updateIntFoilSec(Integer intFoil) throws RemoteException;
    public ResponseBean updateIeFoilSec(Integer ieFoil) throws RemoteException;
    public ResponseBean updateExtFoilSec(Integer extFoil) throws RemoteException;
