...
/**
 * Describe class AddContact here.
 *
 *
 * Created: Thu Sep 08 13:50:48 2005
 *
...
public class AddContact extends HttpServlet {
	...
	try {
		...
		stmt = conn.prepareStatement("INSERT INTO Contact (clientId, firstName, lastName, department, phone, mobile, fax, email, title, comment) " +
					     "VALUES(?,?,?,?,?,?,?,?,?,?)");
		stmt.setInt(1, 
			    Integer.parseInt(httpServletRequest.getParameter("clientId")));
		stmt.setString(2,
			       httpServletRequest.getParameter("firstName"));
		stmt.setString(3,
			       httpServletRequest.getParameter("lastName"));
		stmt.setString(4,
			       httpServletRequest.getParameter("department"));
		stmt.setString(5,
			       httpServletRequest.getParameter("phone"));
		stmt.setString(6,
			       httpServletRequest.getParameter("mobile"));
		stmt.setString(7,
