...
public class UsaStdNeechipataForm implements Serializable {
     ...
     * @return an RDF URI by concatenating the string <code>http://www.kds.ro/readybeans/rdf/forms/UsaStdNeechipata#</code>
     * with the name of the field.
     */
     public static String uri(String fieldName) {
	return "http://www.kds.ro/readybeans/rdf/forms/UsaStdNeechipata#" + fieldName;
     }
