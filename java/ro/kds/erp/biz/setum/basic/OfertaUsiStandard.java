...
public interface OfertaUsiStandard extends EJBObject {
     ...
     */
     public OfertaUsiStandardForm getForm() throws RemoteException;
    ...
    public ResponseBean lineItemsCount() throws RemoteException;
    ...
    public ResponseBean offerReportData() throws RemoteException;
