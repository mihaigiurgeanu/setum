...
public abstract class PanouLateralBean 
	...
	Script script = TclFileScript.loadScript(getScriptPrefix() + ".lpl");
	if(script.loaded()) {
	   try {
		script.setVar(LOGIC_VARNAME, this, this.getClass());
	...
	Script script = TclFileScript.loadScript(getScriptPrefix() + ".hpl");
	if(script.loaded()) {
	   try {
		script.setVar(LOGIC_VARNAME, this, this.getClass());
		script.setVar(OLDVAL_VARNAME, oldVal, Double.class);
     ...
     * the script ro.kds.erp.biz.setum.basic.PanouLateral.faraGeam
     ...
     * the script ro.kds.erp.biz.setum.basic.PanouLateral.faraGrilaj
     * to execute the request.
     * 
     * The <code>ResponseBean</code> to be returned will be automatically populated with the
     * fields modified by the script and the changes will be automatically added to the
     ...
     * the script ro.kds.erp.biz.setum.basic.PanouLateral.faraTabla
     * to execute the request.
     * 
     * The <code>ResponseBean</code> to be returned will be automatically populated with the
     * fields modified by the script and the changes will be automatically added to the
     ...
     */
     protected String getScriptPrefix() {
         ...
         try {
             ...
             logger.log(BasicLevel.DEBUG, e);
             return "ro.kds.erp.biz.setum.basic.PanouLateral";
         }
